            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Nueva Región</h1>
                    ...
                    <form class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="txtNombreRegion" placeholder="Región">
                            </div>
                            <div class="col-12">
...
<script src="<?= base_url('js/configuracionDataTables.js') ?>"></script></body>
